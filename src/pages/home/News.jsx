...
const News = () => (
  <div className="bg-black px-4 md:px-8 lg:px-16 flex justify-center relative overflow-hidden">
    ...
    <div className="absolute inset-0 opacity-10">
      ...
      <div className="absolute bottom-32 right-20 w-32 h-32 border border-[#00F5FF] transform rotate-12 animate-bounce"></div>
      <div className="absolute top-1/2 left-1/4 w-2 h-32 bg-gradient-to-b from-[#FF4655] to-transparent transform -rotate-12"></div>
      <div className="absolute top-1/3 right-1/3 w-1 h-20 bg-gradient-to-b from-[#00F5FF] to-transparent transform rotate-45"></div>
      ...
      <section className="mx-4">
        ...
        <div className="text-center mb-20">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12">
            <div className="flex items-center gap-2 text-[#00FF88]">
              ...
              <span className="font-bold">1000+ Accounts Available</span>
            </div>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8 mb-20">
          {[
            ...
            <div key={index} className={`group relative bg-gradient-to-br from-[#1F1F1F] to-[#2A2A2A] rounded-3xl overflow-hidden border-2 ${category.popular ? 'border-[#00F5FF]' : 'border-gray-800'} hover:border-opacity-70 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl`}>
              {/* Popular badge */}
              {category.popular && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-20">
                  <div className="bg-[#00F5FF] text-black px-6 py-2 rounded-full font-bold text-sm">
                    MOST POPULAR
                  </div>
                </div>
              )}
              ...
              <div className="relative z-10 p-8 text-center">
                ...
                <h3 className="font-black text-2xl mb-2" style={{color: category.color}}>
                  {category.title}
                </h3>
                <p className="text-gray-400 text-sm mb-4 uppercase tracking-wider">{category.subtitle}</p>
                <div className="text-3xl font-bold text-white mb-6">{category.price}</div>
                
                <ul className="space-y-3 mb-8">
                  {category.features.map((feature, fIndex) => (
                    <li key={fIndex} className="flex items-center justify-center gap-2 text-gray-300">
                ...
                <button 
                  className={`w-full py-4 rounded-xl font-bold transition-all duration-300 hover:scale-105 hover:shadow-lg ${
                    category.popular 
        ...
        {/* Why Choose Us */}
        <div className="bg-gradient-to-r from-[#1A1A1A] via-[#2A2A2A] to-[#1A1A1A] rounded-3xl p-12 border border-gray-700 mb-20">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { icon: "⚡", title: "Instant Delivery", desc: "Get your account within 5 minutes of payment" },
              { icon: "🛡️", title: "100% Secure", desc: "All accounts are verified and safe to use" },
              { icon: "💰", title: "Best Prices", desc: "Competitive pricing with regular discounts" },
              { icon: "🎮", title: "Premium Quality", desc: "Hand-picked accounts with valuable items" }
            ].map((item, index) => (
              <div key={index} className="text-center group">
                <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">{item.icon}</div>
                <h3 className="font-bold text-xl text-[#00F5FF] mb-2">{item.title}</h3>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-[#FF4655]/20 via-[#FF4655]/10 to-[#FF4655]/20 rounded-3xl p-12 border-2 border-[#FF4655]/30">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <a 
                href="/shop" 
                className="group/btn relative px-12 py-5 bg-gradient-to-r from-[#FF4655] to-[#FF6B7A] text-white font-bold text-lg rounded-xl transform transition-all duration-300 hover:scale-110 hover:shadow-[0_15px_35px_rgba(255,70,85,0.6)] focus:outline-none no-underline"
              >
              ...
              <a 
                ...
                className="flex items-center gap-3 px-10 py-4 border-2 border-[#00F5FF]/50 text-[#00F5FF] font-semibold text-lg rounded-xl hover:bg-[#00F5FF]/10 transition-all duration-300 no-underline hover:scale-105"
              >
